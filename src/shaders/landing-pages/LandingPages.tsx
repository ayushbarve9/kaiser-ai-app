...
const buildTidecrestDocument = (v: any) => undefined;
const buildMeridianDocument = (v: any, p?: any) => undefined;
const buildAsciiFieldDocument = (v: any) => undefined;
const buildBetawiseGlobeDocument = (v: any) => undefined;
...
const buildNocturneDocument = (v: any) => undefined;
const buildSandboxedPageDocument = (s: any, opt?: any) => s;
...
export function NocturneHero({
  ...
  const safeVariant = (NOCTURNE_VARIANTS as readonly string[]).includes(variant) ? (variant as "midnight") : "midnight";
  const [type, frame] = splitTypographyProps(props);
...
export { JapaneseTowerLandscape, type JapaneseTowerLandscapeProps, type TowerCountry, TOWER_COUNTRIES } from "../japanese-tower/JapaneseTowerLandscape";
